...
import { FiMail, FiUsers, FiMenu, FiUser, FiMessageCircle, FiFile, FiHome } from 'react-icons/fi';
...
const LinkItems: Array<LinkItemProps> = [
  ...
  { name: 'academy', path: '/academies', entity: 'academy', service: AccessServiceEnum.PROJECT, icon: FiHome },
  { name: 'drill', path: '/drills', entity: 'drill', service: AccessServiceEnum.PROJECT, icon: FiHome },
  {
    name: 'player_progress',
    path: '/player-progresses',
  ...
  { name: 'schedule', path: '/schedules', entity: 'schedule', service: AccessServiceEnum.PROJECT, icon: FiHome },
  { name: 'team', path: '/teams', entity: 'team', service: AccessServiceEnum.PROJECT, icon: FiHome },
